...
-- Multi-track URLs
local tracksURLs = {
    ["1"] = "https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/arunika1.json",
    ["2"] = "https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/arunika2.json",
    ["3"] = "https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/arunika3.json",
    ["4"] = "https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/arunika4.json",
    ["5"] = "https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/arunika5.json",
    ["6"] = "https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/arunika6.json",
    ["7"] = "https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/arunika7.json",
...
while elapsed < duration and running do
    ...
    local currentPos
    if math.abs(deltaY) > 5 then
        -- Tangga curam, pisahkan horizontal & vertical biar ga ngelayang
        local t_h = math.clamp(elapsed / (duration * 0.7), 0, 1)
        local t_v = math.clamp(elapsed / (duration * 0.3), 0, 1)

        local horizPos = Vector3.new(
            startPos.X + (targetPos.X - startPos.X) * t_h,
            startPos.Y,
            startPos.Z + (targetPos.Z - startPos.Z) * t_h
        )
        local vertPos = Vector3.new(
            targetPos.X,
            startPos.Y + (targetPos.Y - startPos.Y) * t_v,
            targetPos.Z
        )

        currentPos = Vector3.new(horizPos.X, vertPos.Y, horizPos.Z)
    else
